...
# Lưu kết quả dự đoán vào DataFrame cho Logistic Regression
...
# Tính các chỉ số hiệu năng cho tập train (Logistic Regression)
...
# Tính các chỉ số hiệu năng cho tập test (Logistic Regression)
...
# Vẽ ROC Curve cho tập test (Logistic Regression)
