...
y_pred_train_proba = lr_model.predict_proba(X_train_sc)
y_pred_test_proba = lr_model.predict_proba(X_test_sc)
...
# Tính toán feature importance từ mô hình Logistic Regression
# Lưu ý: Với Logistic Regression, ta sử dụng hệ số (coefficients) làm thước đo cho feature importance.
...
print("\nFeature Importances từ mô hình Logistic Regression:")
