...
# ----------------------
# Áp dụng Borderline-SMOTE và huấn luyện Random Forest
# ----------------------
from imblearn.over_sampling import BorderlineSMOTE
...
# Random Forest sử dụng dữ liệu đã oversample
rf_model = RandomForestClassifier(random_state=42, n_estimators=100)
rf_model.fit(X_train_sc_bsmote, y_train_bsmote)

# Dự đoán xác suất trên tập huấn luyện và kiểm tra
y_pred_train_proba = rf_model.predict_proba(X_train_sc)
y_pred_test_proba = rf_model.predict_proba(X_test_sc)
...
# Tính toán feature importance từ mô hình Random Forest
