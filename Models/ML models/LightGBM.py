...
# ----------------------
# Áp dụng Borderline-SMOTE và huấn luyện LightGBM
# ----------------------
...
# LightGBM sử dụng dữ liệu đã oversample
lgbm_model = LGBMClassifier(random_state=42, n_estimators=100)
lgbm_model.fit(X_train_sc_bsmote, y_train_bsmote)
...
# Tính toán feature importance từ mô hình LightGBM
