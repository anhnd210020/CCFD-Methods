...
df['cust_age_groups'] = df['cust_age'].apply(lambda x: 'below 10' if x < 10 else ('10-20' if x >= 10 and x < 20 else ('20-30' if x >= 20 and x < 30 else ('30-40' if x >= 30 and x < 40 else ('40-50' if x >= 40 and x < 50 else ('50-60' if x >= 50 and x < 60 else ('60-70' if x >= 50 and x < 70 else ('70-80' if x >= 70 and x < 80 else 'Above 80'))))))))
...
# ----------------------
# Áp dụng Borderline-SMOTE và huấn luyện XGBoost
# ----------------------
...
# Tính toán feature importance từ mô hình XGBoost
