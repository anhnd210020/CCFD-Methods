...
# %% Tạo các sequence
sequence_length = 30  # số giao dịch trong 1 sequence
...
# %% Tạo DataLoader với delta T được bình phương
batch_size = 64
X_train_tensor = torch.tensor(X_train_seq, dtype=torch.float32)
X_test_tensor = torch.tensor(X_test_seq, dtype=torch.float32)
# Delta T được bình phương
delta_train_tensor = torch.abs(torch.randn(X_train_tensor.size(0), sequence_length, 1)) ** 2
delta_test_tensor = torch.abs(torch.randn(X_test_tensor.size(0), sequence_length, 1)) ** 2
