...
def main():
    ...
    for epoch in range(epochs):
        ...
        if test_f1 + test_auc > best_score:
            ...
            with open("/home/ducanh/Credit Card Transactions Fraud Detection/THLSTM/Fraud_train_Split/best_checkpoint_results.json", "w") as f:
                json.dump(best_checkpoint, f, indent=4)
            print(f"New best checkpoint saved!")

    # Lưu mô hình tốt nhất
    if best_checkpoint:
        torch.save(model.state_dict(), "/home/ducanh/Credit Card Transactions Fraud Detection/THLSTM/Fraud_train_Split/best_model.pth")
